				...
				<div class="row align-items-center">
					<div class="col-lg-6 offset-lg-4">
						<div class="padding40 rounded-3 shadow-soft"
							...
							<form action="vendorController" method="post" class="form-border">
								<div class="field-set">
								...
								<div id="submit">
									<input type="submit" id="send_message" value="login"
										name="action" class="btn-main btn-fullwidth rounded-3" />
								</div>
							</form>
							<br>
							<div class="row g-2">
								<div class="col-lg-8">
									<a href="seller-forgot-password.jsp">Forgotten password?</a>
								</div>
