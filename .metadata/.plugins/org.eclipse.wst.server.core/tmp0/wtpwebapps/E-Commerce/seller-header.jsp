								...
								<li>
									...
									<div class="setting ht-setting">
										<ul class="ht-setting-list">
											<li><a href="Client-login.jsp">My Account</a></li>
					...
					<div class="col-lg-3">
						<div class="logo pb-sm-30 pb-xs-30">
							<a href="index.html"> <img
								src="images/menu/logo/car pool.jpg" alt="">
							</a>
						</div>
					</div>
						...
						<div class="header-middle-right">
							<ul class="hm-menu">
								...
								<li class="hm-wishlist"><a href="wishlist.html"> <span
										...
										class="fa fa-heart-o"></i> <!-- content: "\f08a"; -->
								</a></li>
						...
						<div class="hb-menu">
							<nav>
								<ul>
									...
									<li class="dropdown-holder"><a> Product </a>
										<ul class="hb-dropdown">
											<li><a href="seller-upload-product.jsp">Upload
													Product</a></li>
											<li><a href="seller-manage-product.jsp">Manage
													Product</a></li>
										</ul></li>
									<li class="dropdown-holder"><a> <%=s.getName()%>
									</a>
										<ul class="hb-dropdown">
											<li><a href="seller-change-password.jsp">Change
													Password</a></li>
											<li><a href="seller-Update-Profile.jsp">Update
													Profile</a></li>
