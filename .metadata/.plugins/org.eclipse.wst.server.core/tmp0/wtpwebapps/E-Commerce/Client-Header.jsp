				...
				<div class="row">
					...
					<div class="col-lg-3">
						<div class="logo pb-sm-30 pb-xs-30">
							<a href="index.html"> <img src="images/menu/logo/car pool.jpg"
								alt="">
							</a>
						</div>
					</div>
						...
						<div class="hb-menu">
							<nav>
								<ul>
									...
									<li class="dropdown-holder"><a> Product
									</a>
										<ul class="hb-dropdown">
											<li><a href="upload-product.jsp">Upload Product</a></li>
											<li><a href="manage-product.jsp">Manage Product</a></li>
										</ul></li>
									<li class="dropdown-holder"><a> <%=c.getFname() %>
									</a>
										<ul class="hb-dropdown">
											<li><a href="change-password.jsp">Change Password</a></li>
											<li><a href="Update-Profile.jsp">Update
													Profile</a></li>
